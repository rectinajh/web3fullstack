<template>
  ...
  >
    ...
    <footer class="footer">
    <div class="container">
      <p class="text-center">© 2024 web3全栈体系. All Rights Reserved.（所有文章未经授权禁止转载、摘编、复制或建立镜像，如有违反，追究法律责任。）</p>
      <p class="text-center"><a href="https://beian.miit.gov.cn" target="_blank">蜀ICP备20023457号-1</a></p>
    </div>
  </footer>
  </div>
</template>
